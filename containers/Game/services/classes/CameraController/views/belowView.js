/** @module containers/Game/services/classes/CameraController/views/belowView */
...
/**
  @summary View from the below function
...
const belowView = (model) => {
  ...
  const positionOffsetVector = new Vector3(Math.sin(rotationY), 10.0, Math.cos(rotationY));
